...
2. To use prior knowledge, provide the existing edges (0 or 1) in the prior knowledge matrix in `python kcrl_demo.py` file. Detailed comments available in the file. 
